...
const Revolution = () => {
	return (
		<div 
		   className="bg-[#0A1126] py-[50px] md:pt-[123px] md:pb-[123px] px-[35px]  md:mt-[0px] md:px-[0]">
			<div 
				className="md:flex md:flex-row flex flex-col-reverse 
				md:max-w-[1240px] md:m-[auto] md:items-start gap-[32px] 
				md:gap-[40px] md:px-[50px]"
			>
				<div 
					...
					<div className="w-1/1  flex flex-col py-[20px] ">
						...
						<div className="flex justify-start mt-[32px]">
							<Link href="/whitepaper.pdf" target='_blank'>
								<button 
								className="  w-[142px] gap-1 md:w-[187px] h-[60px] mb-[56px] 
						          flex text-center justify-center rounded-[64px] text-[#fff] text-[14px] 
								 font-[600] leading-[18px] md:px-[40px] px-[12px] py-[18px] md:py-[21px] gradient-button">
									Learn more
									<Image
									src="/arrow-right.png"
									alt="arrow-icon"
