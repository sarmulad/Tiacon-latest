...
const Roadmap = ()=>{
    return(           
        <div className='bg-[#0A0F20] w-full md:w-[1300px] m-auto pt-[0px] md:pt-[100px] pb-[30px] px-[35px] mt-[0px] md:mt-[0px] md:px-[0]'>
            <h1 className="font-bold text-[24px] md:text-[48px] text-center leading-[51px] mb-[60px] md:mb-[80px]">Roadmap</h1>
